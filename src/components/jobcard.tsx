...
export default function JobCard({ job }: JobCardProps) {
  return (
    <div className="flex justify-between items-center border-2 rounded-2xl p-4 bg-white shadow-sm" style={{ borderColor: '#5D9252' }}>
      <div className="flex-1 pr-4">
        ...
        <p className="text-xs text-black">{job.posteddayagos} days ago</p>
